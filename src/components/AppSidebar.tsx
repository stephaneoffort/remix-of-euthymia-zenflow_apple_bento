              ...
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {f.key === "overdue" && overdueCount > 0 && (
                    <span data-numeric className="font-numeric tabular-nums absolute -top-0.5 -right-0.5 w-4 h-4 bg-priority-urgent text-[hsl(var(--tone-on-solid))] rounded-full text-label flex items-center justify-center font-bold">
            ...
            <>
              {QUICK_FILTERS.map((f) => (
                ...
                >
                  ...
                  {f.label}
                  {f.key === "overdue" && overdueCount > 0 && (
                    <span data-numeric className="font-numeric tabular-nums ml-auto text-xs bg-priority-urgent text-[hsl(var(--tone-on-solid))] rounded-full px-1.5 py-0.5">
                      {overdueCount}
                    </span>
                  )}
                </button>
