...
function ThemeSwitcher() {
  ...
  const palettes: { key: typeof palette; label: string; colors: string[] }[] = [
    ...
    { key: "liquidGlassAmber", label: "LG Amber", colors: ["#d97706", "#fbbf24"] },
    { key: "liquidGlassViolet", label: "LG Violet", colors: ["#7c3aed", "#a78bfa"] },
    { key: "liquidGlassCoral", label: "LG Coral", colors: ["#dc2626", "#fb7185"] },
    { key: "liquidGlassSlate", label: "LG Slate", colors: ["#475569", "#94a3b8"] },
    { key: "liquidGlassMidnight", label: "LG Midnight", colors: ["#1e1b4b", "#818cf8"] },
