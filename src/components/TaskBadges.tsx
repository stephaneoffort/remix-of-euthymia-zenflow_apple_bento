...
export function ZoomSessionBadge({ hasZoom }: { hasZoom: boolean }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-primary/10 text-primary" title="Session Zoom">
...
export function MeetSessionBadge({ hasMeet }: { hasMeet: boolean }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-accent text-accent-foreground" title="Google Meet">
