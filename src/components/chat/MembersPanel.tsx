...
export function MembersPanel({ memberProfiles, onDmCreated, onlineTeamMemberIds = new Set() }: Props) {
  ...
  return (
    <div className="w-60 border-l border-border/20 backdrop-blur-xl bg-card/15 shrink-0 overflow-y-auto hidden md:block shadow-[inset_1px_0_0_rgba(255,255,255,0.04)]">
      <div className="p-3">
