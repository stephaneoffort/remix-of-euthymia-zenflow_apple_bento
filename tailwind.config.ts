  ...
  theme: {
    ...
    screens: {
      ...
      colors: {
        ...
        tone: {
          "sage-solid": "hsl(var(--tone-sage-solid))",
          "sage-bg": "hsl(var(--tone-sage-bg))",
          "sage-fg": "hsl(var(--tone-sage-fg))",
          "slate-solid": "hsl(var(--tone-slate-solid))",
          "slate-bg": "hsl(var(--tone-slate-bg))",
          "slate-fg": "hsl(var(--tone-slate-fg))",
          "sand-solid": "hsl(var(--tone-sand-solid))",
          "sand-bg": "hsl(var(--tone-sand-bg))",
          "sand-fg": "hsl(var(--tone-sand-fg))",
          "terracotta-solid": "hsl(var(--tone-terracotta-solid))",
          "terracotta-bg": "hsl(var(--tone-terracotta-bg))",
          "terracotta-fg": "hsl(var(--tone-terracotta-fg))",
          "lavender-solid": "hsl(var(--tone-lavender-solid))",
          "lavender-bg": "hsl(var(--tone-lavender-bg))",
          "lavender-fg": "hsl(var(--tone-lavender-fg))",
          "rose-solid": "hsl(var(--tone-rose-solid))",
          "rose-bg": "hsl(var(--tone-rose-bg))",
          "rose-fg": "hsl(var(--tone-rose-fg))",
          "mist-solid": "hsl(var(--tone-mist-solid))",
          "mist-bg": "hsl(var(--tone-mist-bg))",
          "mist-fg": "hsl(var(--tone-mist-fg))",
          "olive-solid": "hsl(var(--tone-olive-solid))",
          "olive-bg": "hsl(var(--tone-olive-bg))",
          "olive-fg": "hsl(var(--tone-olive-fg))",
          "ochre-solid": "hsl(var(--tone-ochre-solid))",
          "ochre-bg": "hsl(var(--tone-ochre-bg))",
          "ochre-fg": "hsl(var(--tone-ochre-fg))",
          "stone-solid": "hsl(var(--tone-stone-solid))",
          "stone-bg": "hsl(var(--tone-stone-bg))",
          "stone-fg": "hsl(var(--tone-stone-fg))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
